...
cv2.setTrackbarPos('High-H', 'mask', int(args.low_s))
cv2.setTrackbarPos('Low-S', 'mask', int(args.low_v))
cv2.setTrackbarPos('High-S', 'mask', int(args.high_h))
cv2.setTrackbarPos('Low-V', 'mask', int(args.high_s))
