...
class GripperManagerTest(unittest.TestCase):
    ...
    def test_when_take_cube_should_call_serial_with_config_take_cube_values(self, config_mock):
    ...
    def test_when_release_cube_should_call_serial_with_config_release_cube_values(self, config_mock):
        custom_config_mock = MagicMock()
    ...
    def test_when_lift_gripper_should_call_serial_with_config_lift_gripper_values(self, config_mock):
        custom_config_mock = MagicMock()
    ...
    def test_when_lower_gripper_should_call_serial_with_config_lower_gripper_values(self, config_mock):
        custom_config_mock = MagicMock()
    ...
    def test_when_widest_gripper_should_call_serial_with_config_widest_gripper_values(self, config_mock):
        custom_config_mock = MagicMock()
