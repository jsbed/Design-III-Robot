...
class GameTest(unittest.TestCase):
    ...
    def _setup_config_mock(self, mock):
        ...
        a_mock = MagicMock()
        a_mock.get_table_height = Mock(return_value=251)
