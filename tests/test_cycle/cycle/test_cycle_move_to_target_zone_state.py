...
class CycleTestMoveToTargetZoneState(unittest.TestCase):
    ...
    def test_move_to_target_zone_state_when_robot_is_next_to_target_with_correct_orientation_then_move_forward_to_target_zone_is_called(
        ...
        assert self._robot_controller_mock.move_forward_to_target_zone.called
