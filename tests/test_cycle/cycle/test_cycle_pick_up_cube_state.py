...
class CycleTestPickUpCubeState(unittest.TestCase):
    ...
    def test_when_pick_up_cube_state_then_robot_controller_is_called(
        ...
        target_zone_position = Point(80, 30)
        ...
        calls = [call.get_gripper().take_cube(),
                 call.get_gripper().lift_gripper(),
                 call.robot_is_next_to_target_with_correct_orientation(
                 target_zone_position),
                 call.move_robot_to(target_zone_position)]
