...
class CycleTestMoveToCubeState(unittest.TestCase):
    ...
    def test_move_to_cube_state_when_robot_is_next_to_target_with_correct_orientation_then_push_cube_is_called(
        ...
        assert self._robot_controller_mock.push_cube.called
