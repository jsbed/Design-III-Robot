...
class CycleTestPutDownCubeState(unittest.TestCase):
    ...
    def test_when_put_down_cube_state_then_robot_controller_is_called(
        ...
        self._robot_controller_mock.instruction_remaining = Mock(
            return_value=False)
        self._robot_controller_mock.push_cube = Mock()
        self._robot_controller_mock.move_forward_to_target_zone = Mock()
        self._robot_controller_mock.move_backward = Mock()
        ...
        calls = [call.get_gripper().lower_gripper(),
                 call.get_gripper().release_cube(),
                 call.move_backward()]

        self._robot_controller_mock.assert_has_calls(calls, any_order=True)
