...
class TestRobotLocationComputerOrangeCyan(unittest.TestCase):

    ROBOT_RADIUS = 8.5

    EXPECTED_LOCALIZATION_WITH_LEFT_CORNERS_AT_RIGHT = Localization(
        Point(46.5, 61.5), 360 - degrees(arctan(8 / 15)))
    ...
    EXPECTED_LOCALIZATION_WITH_LEFT_CORNERS_AT_LEFT = Localization(
        Point(53.5, 61.5), 270 + degrees(arctan(8 / 15)))
    ...
    def test_orange_cyan_left_corners_when_robot_at_right(self, config_mock):
    ...
    def test_orange_cyan_right_corners_when_robot_at_right(self, config_mock):
        self._setup_config_mock(config_mock)
    ...
    def test_orange_cyan_left_corners_when_robot_at_left(self, config_mock):
        self._setup_config_mock(config_mock)
        close_corner = RobotCorner(Point(50, 50), Color.CYAN)
    ...
    def test_orange_cyan_front_corners_when_robot_at_left(self, config_mock):
        self._setup_config_mock(config_mock)
        close_corner = RobotCorner(Point(50, 50), Color.ORANGE)
    ...
    def test_orange_cyan_right_corners_when_robot_at_left(self, config_mock):
        self._setup_config_mock(config_mock)
        close_corner = RobotCorner(Point(65, 58), Color.ORANGE)
        far_corner = RobotCorner(Point(57, 73), Color.CYAN)
