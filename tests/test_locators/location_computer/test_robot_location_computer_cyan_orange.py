...
class TestRobotLocationComputerCyanOrange(unittest.TestCase):
    ...
    def test_cyan_orange_left_corners_when_robot_at_right(self, config_mock):
    ...
    def test_cyan_orange_right_corners_when_robot_at_right(self, config_mock):
        self._setup_config_mock(config_mock)
    ...
    def test_cyan_orange_left_corners_when_robot_at_left(self, config_mock):
        self._setup_config_mock(config_mock)
        close_corner = RobotCorner(Point(50, 50), Color.ORANGE)
    ...
    def test_cyan_orange_front_corners_when_robot_at_left(self, config_mock):
        self._setup_config_mock(config_mock)
        close_corner = RobotCorner(Point(50, 50), Color.CYAN)
    ...
    def test_cyan_orange_right_corners_when_robot_at_left(self, config_mock):
        self._setup_config_mock(config_mock)
