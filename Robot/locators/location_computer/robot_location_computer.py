...
def _compute_localization_for_reversed_side(close_corner, far_corner):
    ...
    middle_point = Point(far_corner.location.x +
                         (close_corner.location.x -
                          far_corner.location.x) / 2,
                         far_corner.location.y +
                         (close_corner.location.y -
                          far_corner.location.y) / 2)

    orientation = arctan((close_corner.location.x - far_corner.location.x) /
