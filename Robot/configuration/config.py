...
class Config(metaclass=Singleton):
    ...
    def get_target_zone_uncertainty_with_orientation(self):
        return float(self._parser.get(SECTION_PATHFINDING,
                                      "OrientationUncertaintyWithTargetZone"))

    def get_target_zone_uncertainty_with_distance(self):
        return float(self._parser.get(SECTION_PATHFINDING,
                                      "DistanceUncertaintyWithTargetZone"))
